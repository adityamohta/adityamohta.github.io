...
export const HackerEarth = (props) => (
    <a className="btn-custom btn-hacker-earth" href="https://www.hackerearth.com/@kumaraditya.mohta" target="_blank" rel="noreferrer">
        HackerEarth <span className="fas fa-arrow-right"/>
    </a>
);

export const LinkedIn = (props) => (
    <a className="btn-custom btn-linkedin" href="https://www.linkedin.com/in/kumaradityamohta" target="_blank" rel="noreferrer">
        <span className="btn-logo fab fa-linkedin" aria-hidden="true"/> LinkedIn <span className="fas fa-arrow-right"/>
    </a>
);

export const Github = (props) => (
    <a className="btn-custom btn-github" href="https://github.com/adityamohta" target="_blank" rel="noreferrer">
...
export const AmcatReport = (props) => (
    <a className="btn-custom btn-amcat" href="assets/doc/amcat_report.pdf" target="_blank" rel="noreferrer">
...
export const Resume = (props) => (
    <a className="btn-custom btn-resume" href="assets/doc/cv.pdf" target="_blank" rel="noreferrer">
...
export const ResumeDownload = (props) => (
    <a className="btn-custom btn-download" href="assets/doc/cv.pdf" target="_blank" rel="noreferrer" download="aditya_mohta">
