    ...
    <div className="portfolio">
        ...
        <div className="portfolio-header">
            ...
            <div className="portfolio-header-content">
                ...
                <p>
                    I am passionate about designing, problem-solving, and learning new technologies. Experienced in
                    full-stack development, working with startups, building products from scratch, and scaling them up.
                </p>
            </div>
        </div>
        ...
        <p>
            ...
            including team members & remote clients, to effectively conduct requirement gathering and optimize solutions
            ...
            <br/>
            <em>“Chiku — Journal / Diary & Mood Tracker”</em> available on both IOS and Android.
        </p>
        <ul>
